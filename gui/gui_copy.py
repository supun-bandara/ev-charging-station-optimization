...
class ChargingStationForm(tk.Toplevel):
    def __init__(self, parent, charging_station):
       ...
       # DC Charger
        self.DC_label =ttk.Label(self, text="DC Fast Charger:",style="bag.TLabel",font=font)
        ...
        # AC Charger
        self.AC_label=ttk.Label(self, text="Level 2 Charger:",style="bag.TLabel",font=font)
